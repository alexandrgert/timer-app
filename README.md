...
**Последний релиз:** [v0.2.2](https://github.com/alexandrgert/timer-app/releases/tag/v0.2.2)

Скачать пакет (Linux amd64):

https://github.com/alexandrgert/timer-app/releases/download/v0.2.2/tasktimer-link-b24-0.2.2-amd64.deb

```bash
wget https://github.com/alexandrgert/timer-app/releases/download/v0.2.2/tasktimer-link-b24-0.2.2-amd64.deb
sudo dpkg -i tasktimer-link-b24-0.2.2-amd64.deb
sudo apt-get install -f
tasktimer-link-b24
```
