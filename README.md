...
```bash
git clone https://github.com/alexandrgert/win-timer-app-v1.git
cd win-timer-app-v1
python -m venv .venv
...
Готовые `.deb` можно прикреплять к [GitHub Releases](https://github.com/alexandrgert/win-timer-app-v1/releases) этого репозитория.
